...
__attribute__((weak))
const vfs_filename_t daplink_url_name =       "SHOP    HTM";
__attribute__((weak))
const vfs_filename_t daplink_drive_name =     "DAPLINK    ";
__attribute__((weak))
const char *const daplink_target_url = "https://shop446922193.taobao.com/?spm=2013.1.1000126.d21.368144e2X32epD";
